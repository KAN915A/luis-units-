...
> Per-topic notes are split into separate files under weekly folders. This page is the **index + mark-scheme reference + template**.

## Index

### Week 1 — Foundation concepts
Folder: [`week-01/`](./week-01/README.md)
